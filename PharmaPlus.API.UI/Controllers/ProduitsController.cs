    ...
    public class ProduitsController : ControllerBase
    {
        ...
        public IActionResult AddOne(Produit produit)
        {
            ...
            Produit addProduit = this._repository.AddOne(new Produit()
            {
                ...
                Drug_code = produit.Drug_code,
                Class_name = produit.Class_name,
                Drug_identification_number = produit.Drug_identification_number,
                Brand_name = produit.Brand_name,
                Descriptor = produit.Descriptor,
                Number_of_ais = produit.Number_of_ais,
                Ai_group_no = produit.Ai_group_no,
                Company_name = produit.Company_name,
                Last_update_date = produit.Last_update_date,
                Purchase_price = produit.Purchase_price,
                Sell_price = produit.Sell_price,
                Ppa = produit.Ppa,
                Expiry_date = produit.Expiry_date
            });
            this._repository.unitOfWork.SaveChanges();
            if(addProduit != null)
            {
